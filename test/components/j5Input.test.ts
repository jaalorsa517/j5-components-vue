...
describe("J5Input component", async () => {
  describe("Test en general", async () => {
    ...
    it("El componente no tiene la prop name", () => {
      ...
      expect(wrapper.find(".j5-input input").attributes().inputmode).toBe(
        "none"
      );
    });
    ...
    it("El componente se actualiza la prop modelValue (v-model)", async () => {
      ...
      let inputElement = wrapper.find(".j5-input input")
      ...
      inputElement = wrapper.find(".j5-input input")
        .element as VueNode<HTMLInputElement>;
  ...
  describe("Test input Text", async () => {
    it("Input-text: Enviando props", async () => {
      ...
      let inputValue = wrapper.find(".j5-input > input")
        .element as VueNode<HTMLInputElement>;
  ...
  describe("Test input email", async () => {
    it("Input-email: Validando atributos al montar", async () => {
      ...
      expect(wrapper.find(".j5-input input").attributes().type).toBe("text");
      expect(wrapper.find(".j5-input input").attributes().inputmode).toBe(
        "email"
      );
    });
    it("Input-email:Validando validador con evento blur", async () => {
      ...
      await wrapper.find(".j5-input input").setValue("emailTest");
      await wrapper.find(".j5-input input").trigger("blur");
      expect(wrapper.find(".j5-label-error").exists()).toBeTruthy();

      await wrapper.find(".j5-input input").setValue("emailTest@test.com");
      await wrapper.find(".j5-input input").trigger("blur");
      expect(wrapper.find(".j5-label-error").exists()).toBeFalsy();
    });
  });
  ...
  describe("Test input tipo tel", async () => {
    ...
    it("Input-tel: Validando validador con evento focus", async () => {
      ...
      await wrapper.find(".j5-input input").trigger("focus");
      expect(wrapper.find(".j5-label-error").exists()).toBeTruthy();

      await wrapper.find(".j5-input input").setValue("1234");
      await wrapper.find(".j5-input input").trigger("blur");
      await wrapper.find(".j5-input input").trigger("focus");
      expect(wrapper.find(".j5-label-error").exists()).toBeFalsy();

      await wrapper.find(".j5-input input").setValue("teltest");
      await wrapper.find(".j5-input input").trigger("blur");
      await wrapper.find(".j5-input input").trigger("focus");
      expect(wrapper.find(".j5-label-error").exists()).toBeTruthy();
    });
  ...
  describe("Test input tipo number", async () => {
    ...
    it("Input-number: Validando escritura del input numero decimal", async () => {
      ...
      await wrapper.find(".j5-input input").setValue("1234.3");
      inputElement = wrapper.find(".j5-input input")
        .element as VueNode<HTMLInputElement>;
    ...
    it("Input-number: Validando escritura del input con una letra", async () => {
      ...
      await wrapper.find(".j5-input input").setValue("1234.f");
      inputElement = wrapper.find(".j5-input input")
        .element as VueNode<HTMLInputElement>;
      expect(inputElement.value).toBe("1234.");
    });
    ...
    it("Input-number: Validando escribir solo numeros", async () => {
      ...
      await wrapper.find(".j5-input input").setValue("1.");
      await wrapper.find(".j5-input input").trigger("input", { data: "." });
      inputElement = wrapper.find(".j5-input input")
        .element as VueNode<HTMLInputElement>;
  ...
  describe("Test clipboard", async () => {
    it("clipboard: Evento paste normal", async () => {
      ...
      await wrapper.find(".j5-input input").trigger("paste", {
        clipboardData: {
          getData: () => "1234",
        },
      });
    ...
    it("clipboard: Evento copy con objeto clipboard existente", async () => {
      ...
      await wrapper.find(".j5-input input").trigger("copy", {
        clipboardData: {
          setData: () => "1234",
        },
      });
